...
export enum TaskStatus { TODO="todo", IN_PROGRESS="in_progress", REVIEW="review", DONE="done", CANCELLED="cancelled" }
...
export class Task {
  ...
  @Column({ type: "decimal", precision: 10, scale: 2, nullable: true }) estimatedHours!: number;
  @Column({ type: "decimal", precision: 10, scale: 2, default: 0 }) loggedHours!: number;
