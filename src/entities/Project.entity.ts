...
export enum ProjectPriority { LOW="low", MEDIUM="medium", HIGH="high", URGENT="urgent" }
...
export class Project {
  ...
  @Column({ type: "enum", enum: ProjectPriority, default: ProjectPriority.MEDIUM }) priority!: ProjectPriority;
